<?php
/* Smarty version 3.1.39, created on 2021-06-18 12:31:08
  from '/Applications/MAMP/htdocs/smarty/templates/smarty.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_60cc920cbba6e7_88361564',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '36814fdb042d796e60104a09278987b05b52d675' => 
    array (
      0 => '/Applications/MAMP/htdocs/smarty/templates/smarty.tpl',
      1 => 1624019466,
      2 => 'file',
    ),
  ),
...
function content_60cc920cbba6e7_88361564 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="ja">
<head>
    <meta charset="UTF-8">
...
?>
                    <tr>
                        <td class="list category"><?php echo $_smarty_tpl->tpl_vars['v']->value['category'];?>
</td>
                        <td class="list name"><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
</td>
                        <td class="list branch_cd"><?php echo $_smarty_tpl->tpl_vars['v']->value['branch_cd'];?>
</td>
                        <td class="list department"><?php echo $_smarty_tpl->tpl_vars['v']->value['department'];?>
</td>
                        <td class="list age"><?php echo $_smarty_tpl->tpl_vars['v']->value['age'];?>
</td>
                        <td class="list sex"><?php echo $_smarty_tpl->tpl_vars['v']->value['sex'];?>
</td>
                        <td class="list memo"><?php echo $_smarty_tpl->tpl_vars['v']->value['memo'];?>
</td>
                        <td class="list img_file"><?php echo $_smarty_tpl->tpl_vars['v']->value['img_file'];?>
</td>
                        <td class="list"><input type="button" class="btn_css edit" data-id="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" value="編集"></td>
                        <td class="list"><input type="button" class="btn_css delete" data-id="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" value="削除"></td>
                    </tr>
                <?php
}
